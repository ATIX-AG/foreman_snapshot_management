module ForemanSnapshotManagement
  class SnapshotsController < ApplicationController
    ...
    before_action :find_snapshot, only: [:destroy, :revert, :update]
    ...
    def create
      ...
      begin
        ...
        if task["task_state"] == "success"
          status = "Snapshot successfully created"
        else
          status = "Error occurred while taking Snapshot: " + task["task_state"]
        end
        ...
        status = "Error occurred while taking Snapshot."
    ...
    def revert
      ...
      if task["state"] == "success"
        status = "VM successfully rolled back"
      else
        status = "Error occurred while rolling back VM: " + task["state"]
      end
    ...
    def update
      ...
      begin
        ...
        render json: {errors: 'Failed to update snapshot'}, status: :unprocessable_entity
      end
    end
